...
class ResBlockDeformableBias(TimestepBlock):
    """
    ...
    def __init__(
        ...
        self.in_layers = nn.Sequential(
            ...
            nn.SiLU(),
            SphereDeformableConv2d(channels, self.out_channels, 3, bias=True)
        )
        ...
        self.out_layers = nn.Sequential(
            ...
            zero_module(
                DeformableConv2d(self.out_channels, self.out_channels, 3, padding=1, bias=True)
            ),
        )
